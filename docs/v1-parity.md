...
| foreground ticks | `cara loop [--once] [--manual --shell COMMAND]` | one-shot envelope only; manual refused | intentionally absent | canonical sync/hooks; CLI-only external-decision evidence file + inherited TTY shell + exact rediscovery |
